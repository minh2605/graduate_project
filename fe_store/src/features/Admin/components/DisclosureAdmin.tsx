      ...
      {({ open }) => (
        <>
          ...
          >
            {({ isActive }) => (
              <Disclosure.Button
                className={`flex items-center w-full justify-between rounded-lg px-4 py-2 text-left text-white text-sm font-medium hover:bg-light-red focus:outline-none transition mb-2 ${
